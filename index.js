...
//Code Here
let postTaxPrices = prices.map(cash => cash * 1.07);
...
//Code Here
// let myStrongest = monstersInYourPocket.map()

// const myStrongest = monstersInYourPocket.map(monster => monster.CP)
// const myStrongest = monstersInYourPocket  
// .map(mon => mon)
// .filter()  
// .reduce()

// const {CP} = monstersInYourPocket
// console.log(CP)

// console.log(`#4. \ncan't seem to find the right syntax to filter the values I pulled with map. I tried several things. The answer from arrayMethods didn't seem to work either \n`)
...
console.log(`\n#1. \n${color} , ${make} , ${model} , ${year}\n`);
  ...
  */
  ...
  function greeting( obj ) {
    ...
    const {firstName , lastName , title} = balls
  ...
  */
  ...
  //Code Here
  function totalPopulation2(obj2) {
    const properties = {
      california: populations[0] ,
      arizona: populations[1] ,
      texas: populations[2] ,
      utah: populations[3] 
    } 

    const {california , arizona , texas , utah} = properties

    return california , arizona , texas , utah

  }
  const {obj2} = totalPopulation2()
  console.log(`#3. \n${totalPopulation2()}\n`);
    ////////// PROBLEM 4 //////////
  ...
  */
  ...
  function ingredients (obj) {
    const macros = {
      protein: 'stronk' ,
      carb: 'yummy' ,
      fat: 'make you full long time'
    }

    const {protein , carb , fat} = macros
    let zeMacros = [protein , carb , fat]
    return zeMacros
  }
  ...
  */
  ...
  function largeNumbers (obj) {
    ...
    const {first , second , third} = sumNums
